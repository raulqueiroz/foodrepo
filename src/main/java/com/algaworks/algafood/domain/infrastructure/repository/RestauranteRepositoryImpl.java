...
public class RestauranteRepositoryImpl implements RestauranteRepositoryQueries {
	...
	@Override
	public List<Restaurante> find(String nome, BigDecimal tavaFreteInicial, BigDecimal taxaFreteFinal) {
		...
		if (tavaFreteInicial != null) {
			predicates.add(builder.greaterThanOrEqualTo(root.get("taxaFrete"), tavaFreteInicial));
		}
	...
	public List<Restaurante> findComFreteGratis(String nome) {
		return restauranteRepository.findAll(comFreteGrais().and(comNomeSemelhante(nome))); 
	}
